...
#for TTbarStr in Tbar_SingleLep; do
	...
	if [ $type -eq 0 ]; then
		...
		echo Transfer_Output_Files = HadTauEstimation_TTbar_${TTbarStr}_${outStr}_${i}_00.root','MuJetMatchRate_TTbar_${TTbarStr}_${outStr}_${i}_00.root','Probability_Tau_mu_TTbar_${TTbarStr}_${outStr}_${i}_00.root>> ${SubmitFile}
		#echo Transfer_Output_Files = MuJetMatchRate_TTbar_${TTbarStr}_${outStr}_${i}_00.root>> ${SubmitFile}        
		echo transfer_output_remaps = '"'HadTauEstimation_TTbar_${TTbarStr}_${outStr}_${i}_00.root = TauHad2Multiple/HadTauEstimation_TTbar_${TTbarStr}_${outStr}_${i}_00.root';'MuJetMatchRate_TTbar_${TTbarStr}_${outStr}_${i}_00.root = TauHad2Multiple/MuJetMatchRate_TTbar_${TTbarStr}_${outStr}_${i}_00.root';'Probability_Tau_mu_TTbar_${TTbarStr}_${outStr}_${i}_00.root = TauHad2Multiple/Probability_Tau_mu_TTbar_${TTbarStr}_${outStr}_${i}_00.root'"'>> ${SubmitFile}
