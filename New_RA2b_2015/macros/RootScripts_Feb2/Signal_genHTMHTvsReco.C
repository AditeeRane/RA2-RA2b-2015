...
void Signal_genHTMHTvsReco() {

  compareResponse("T2tt_SignalFiles_Dec28_7.10_WithoutgenHTMHT_Lumi1ipb.root", "T2tt_SignalFiles_Dec28_7.30_genHTMHT_Lumi1ipb.root", "mStop_1000_mLSP_50","mStop_1000_mLSP_50",0,0,1,1);
...
*/
  char cname[500];
  TCanvas *c = new TCanvas("Signal_genHTMHTvsReco","Signal_genHTMHTvsReco", 500, 500);
