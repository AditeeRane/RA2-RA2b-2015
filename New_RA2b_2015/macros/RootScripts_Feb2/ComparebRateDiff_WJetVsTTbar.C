...
void ComparebRateDiff_WJetVsTTbar() {
  ...
  compareResponse("hist_bRateDiff_TauVsMu_WJet.root", "hist_bRateDiff_TauVsMu_TTbar.root","hDiff","hDiff",0,0,1,1);
