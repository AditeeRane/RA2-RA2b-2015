...
void CompareTemplates() {
  ...
  compareResponse("ARElog69_HadTau_TauResponseTemplates_stacked.root", "hist_taugun_aditee.root", "hTauResp_0",0,0,1,1);
  compareResponse("ARElog69_HadTau_TauResponseTemplates_stacked.root", "hist_taugun_aditee.root", "hTauResp_1",0,0,1,1);
  compareResponse("ARElog69_HadTau_TauResponseTemplates_stacked.root", "hist_taugun_aditee.root", "hTauResp_2",0,0,1,1);
  compareResponse("ARElog69_HadTau_TauResponseTemplates_stacked.root", "hist_taugun_aditee.root", "hTauResp_3",0,0,1,1);
...
void compareResponse(char* WJetTTbarMC, char* Wgun, char *histname, bool logy, bool logx, bool overlay,bool normalized){
  ...
  if(histname=="hTauResp_0" || histname=="hTauResp_0_Up" || histname=="hTauResp_0_Down")    
    sprintf(hname, "WJetTTbarMC vs Wgun(20-30GeV");   
  else if(histname=="hTauResp_1"  || histname=="hTauResp_1_Up" || histname=="hTauResp_1_Down")    
    sprintf(hname, "WJetTTbarMC vs Wgun(30-50GeV");
  else if(histname=="hTauResp_2" || histname=="hTauResp_2_Up" || histname=="hTauResp_2_Down")    
    sprintf(hname, "WJetTTbarMC vs Wgun(50-100GeV");
  else
    sprintf(hname, "WJetTTbarMC vs Wgun(Above 100GeV");
    
    
    
  TH1F *h1 = (TH1F*)_file0->FindObjectAny(histname);
  h1->SetName("WJetTTbarMC");
