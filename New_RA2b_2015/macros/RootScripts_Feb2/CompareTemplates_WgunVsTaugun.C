...
void CompareTemplates_WgunVsTaugun() {
  ...
  //compareResponse("hist_taugun_aditee_Oct12_12.00_WithGenTemplates.root", "hist_taugun_aditee_Oct13_17.20_UsingTauGun.root", "hTauResp_3",0,0,1,1);
  compareResponse("hist_taugun_aditee_Oct12_12.00_WithGenTemplates.root", "hist_taugun_aditee.root", "hTauRespGen_0",0,0,1,1);
  compareResponse("hist_taugun_aditee_Oct12_12.00_WithGenTemplates.root", "hist_taugun_aditee.root", "hTauRespGen_1",0,0,1,1);
  compareResponse("hist_taugun_aditee_Oct12_12.00_WithGenTemplates.root", "hist_taugun_aditee.root", "hTauRespGen_2",0,0,1,1);
  compareResponse("hist_taugun_aditee_Oct12_12.00_WithGenTemplates.root", "hist_taugun_aditee.root", "hTauRespGen_3",0,0,1,1);
...
void compareResponse(char* WJetTTbarMC, char* Wgun, char *histname, bool logy, bool logx, bool overlay,bool normalized){
  ...
  if(histname=="hTauResp_0")    
    sprintf(hname, "Wgun vs Taugun(20-30GeV");   
  else if(histname=="hTauResp_1")    
    sprintf(hname, "Wgun vs Taugun(30-50GeV");
  else if(histname=="hTauResp_2")    
    sprintf(hname, "Wgun vs Taugun(50-100GeV");
  else
    sprintf(hname, "Wgun vs Taugun(Above 100GeV");
