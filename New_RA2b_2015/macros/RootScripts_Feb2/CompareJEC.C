...
void CompareJEC() {
  ...
  compareResponse("hist_taugun_aditee.root", "hist_taugun_aditee.root","hTauResp_0","hTauResp_0_Up",0,0,1,1);
  compareResponse("hist_taugun_aditee.root", "hist_taugun_aditee.root","hTauResp_1","hTauResp_1_Up",0,0,1,1);
  compareResponse("hist_taugun_aditee.root", "hist_taugun_aditee.root","hTauResp_2","hTauResp_2_Up",0,0,1,1);
  compareResponse("hist_taugun_aditee.root", "hist_taugun_aditee.root","hTauResp_3","hTauResp_3_Up",0,0,1,1);
...
void compareResponse(char* WJetTTbarMC, char* Wgun, char* histOne, char *histTwo, bool logy, bool logx, bool overlay,bool normalized){
  ...
  TH1F *hAveDiff = new TH1F("hAveDiff","Average of (tau-mu) mistag from Wjet+TTbar",100,0.,1000.);    
  int Nbins=100;
*/
  ...
  for(int j=1;j<=Nbins;j++){
    double Diff_WJet=h1->GetBinContent(j);
    double Diff_TTbar=h2->GetBinContent(j);
    double aveRate=(Diff_WJet+Diff_TTbar)/2;
    hAveDiff->SetBinContent(j,aveRate);
  }
  */
