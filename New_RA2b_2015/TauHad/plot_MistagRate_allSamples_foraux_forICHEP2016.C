...
void plot_MistagRate_allSamples_foraux_forICHEP2016(string sample="TTbar_", int wjets_hadtau_only=0, bool debug=false){
  ...
  TFile file_WJet("TauHad/Stack/TauBtaggedRate_WJet_stacked.root","R");
