...
if ( -e /eos/uscms/store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV11/scan/T2tt_mMother-${m}_mLSP-${d}_fast.root ) then
  echo  root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV11/scan/T2tt_mMother-${m}_mLSP-${d}_fast.root  


  echo root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV11/scan/T2tt_mMother-${m}_mLSP-${d}_fast.root > RA2bin_T2tt_${m}_${d}_fast
#else
